...
namespace MowControl
{
    ...
    {
        public WeatherForecast(ISmhi smhi, int maxHourlyThunderPercent, double maxHourlyPrecipitationMillimeter, int maxRelativeHumidityPercent)
        {
            Smhi = smhi;
