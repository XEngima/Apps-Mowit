...
namespace MowerTests
{
    ...
    public class SmhiRainSensorTests
    {
        ...
        public void IsWet_RainInEveningThenALongNight_Wet()
        {
            ...
            var smhi = new TestSmhi(systemTime, new ForecastTimeSerie[]
            {
                NewTimeSerie(new DateTime(2018, 8, 14, 5, 0, 0), precipitationMax: 0m, relativeHumidity: 45),
            });

            // Past weather
            var rainSensor = new SmhiRainSensor(systemTime, smhi, new ForecastTimeSerie[] {
                NewTimeSerie(new DateTime(2018, 8, 13, 12, 22, 0), precipitationMax: 1m, relativeHumidity: 95),
                NewTimeSerie(new DateTime(2018, 8, 13, 13, 23, 0), precipitationMax: 0, relativeHumidity: 95),
                NewTimeSerie(new DateTime(2018, 8, 14, 14, 0, 0), precipitationMax: 0, relativeHumidity: 95),
                NewTimeSerie(new DateTime(2018, 8, 14, 15, 1, 0), precipitationMax: 0, relativeHumidity: 95),
                NewTimeSerie(new DateTime(2018, 8, 14, 16, 2, 0), precipitationMax: 0, relativeHumidity: 95),
                NewTimeSerie(new DateTime(2018, 8, 14, 17, 3, 0), precipitationMax: 0, relativeHumidity: 95),
